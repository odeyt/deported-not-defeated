...
export async function POST(req: NextRequest) {
  ...
  await supabase.from("newsletter_subscribers").insert({ email, name: name || null });
  ...
  await resend.emails.send({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:500px;margin:0 auto">
        ...
        <hr/>
        <p style="color:#6b7280;font-size:12px">Deported Not Defeated — deportednotdefeated.com</p>
      </div>
    `,
  });
      ...
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;background:#fff">
        ...
        <div style="padding:32px 40px;background:#f9fafb">
          ...
          <p style="color:#374151;font-size:15px;line-height:1.7;margin:0 0 24px">
            Your <strong>Laos Restart Checklist: First 30 Days After Deportation</strong> covers everything you need — housing, phone, money, legal documents, and more — step by step.
          </p>
          ...
          <div style="background:#eff6ff;border-left:4px solid #1d4ed8;padding:16px 20px;border-radius:0 8px 8px 0;margin:24px 0">
            <p style="color:#1e3a5f;font-size:13px;margin:0;line-height:1.6">
              <strong>Note:</strong> This checklist applies after you have self-deported or been released from the Laos Immigration Welcome Center, Lak 19, Ban Dong Makkai.
            </p>
          </div>

          <p style="color:#374151;font-size:15px;line-height:1.7;margin:24px 0 0">
            Your story is not over. Start with one step forward.
          </p>
