...
const guides = [
  ...
  { href: "/cambodia/housing-phnom-penh",          title: "Business Directory",   desc: "Find verified local businesses that can support you and help you rebuild.",                             pos: "33.3% 0%"  },
  { href: "/cambodia/housing-phnom-penh",          title: "Find Housing",         desc: "Search for safe, affordable housing options and long-term rentals in Phnom Penh.",                      pos: "66.6% 0%"  },
  { href: "/cambodia/find-work-cambodia",          title: "Find Work",            desc: "Access job listings, training programs, and resources to help you get back to work.",                   pos: "100% 0%"   },
  { href: "/cambodia/start-over-after-deportation",title: "Legal & Documents",    desc: "Get help with visas, IDs, legal rights, and important documents.",                                      pos: "0% 50%"    },
  { href: "/cambodia/hospitals-phnom-penh",        title: "Healthcare",           desc: "Find clinics, mental health support, and medical services you can trust.",                              pos: "33.3% 50%" },
  { href: "/cambodia/receive-money-usa-to-cambodia",title: "Banking & Money",     desc: "Open accounts, send or receive money, and manage your finances with confidence.",                       pos: "66.6% 50%" },
  { href: "/cambodia/sim-card-cambodia",           title: "Phone & Internet",     desc: "Get a SIM card, affordable plans, and stay connected with family.",                                     pos: "100% 50%"  },
  { href: "/cambodia/cost-of-living-phnom-penh",   title: "Transportation",       desc: "Learn about getting around Phnom Penh — tuk-tuks, motos, and public transport.",                       pos: "0% 100%"   },
  { href: "/resources",                            title: "All Resources",        desc: "Checklists, guides, articles, and tools to help you rebuild your life with hope and dignity.",          pos: "33.3% 100%"},
];
            ...
            {guides.map((g) => (
              ...
              >
                <div
                  ...
                  style={{
                    backgroundImage: "url('/images/cambodia-grid.jpg')",
